...
/****** Object:  StoredProcedure [dbo].[B_CONTINGENT_ENTRY_Insert_Update]    Script Date: 12/12/2014 11:04:16 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[B_CONTINGENT_ENTRY_Insert_Update](@CollateralInfoID nvarchar(20), @ContingentEntryID nvarchar(20), @CustomerID nvarchar(20), @CustomerAddress nvarchar(250),
 ...
 ,[CustomerAddress]=@CustomerAddress,[DocIDTaxCode]=@DocIDTaxCode,[DateOfIssue]=@DateOfIssue,[TransactionCode]=@TransactionCode,[TransactionName]=@TransactionName
      ...
      ,[ValueDate]=@ValueDate,[Narrative]=@Narrative,[ApprovedUser]=@ApprovedUser, [CollateralType_Code] = @CollateralTypeCode, [ReferenceID] = @ReferenceID
...
, @Currency, @AccountNo, @AccountName,@Amount,  @DealRate, @ValueDate,@Narrative,  @ApprovedUser,@CollateralTypeCode, @ReferenceID)
END
